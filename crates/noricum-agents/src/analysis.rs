...
pub struct AnalysisResult {
    ...
    pub strategy: String,
    /// Semantic hints detected by deterministic pattern analysis.
    /// These are NOT generated by the LLM — they are populated by
    /// `detect_semantic_patterns()` after the analysis call returns.
    #[serde(default)]
    pub semantic_hints: Vec<noricum_ir::SemanticHint>,
}
